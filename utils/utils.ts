 ...
 */
export const checkIfModalIsFullyVisible = (modalContentRef: React.RefObject<View>,  setModalTopOffset:(val: number)=>void, scrollViewRef: React.RefObject<Animated.ScrollView>, scrollY: number ) => {
