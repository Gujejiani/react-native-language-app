...
import { CustomThemeContext, initialTheme, ThemeInterface } from './themeContext';
...
// Provider Component
export const CustomThemeProvider: React.FC<ThemeProviderProps> = ({ children, onThemeChange }) => {
