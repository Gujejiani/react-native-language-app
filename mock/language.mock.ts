...
export const modulesMock: IModule[] = [
    {
        ...
        description: { en: "Introduction to TypeScript", es: "Introducción a TypeScript" },
        ...
        lessons: [
            {
                ...
                description: { en: "Getting started with TypeScript", es: "Empezando con TypeScript" },
                        ...
                        questions: [
                            {
                                ...
                                options: [
                                    { id: 1, optionText: "A superset of JavaScript", isCorrect: true },
            ...
            },
            {
                ...
                description: { en: "TypeScript basic types", es: "Tipos básicos en TypeScript" },
        ...
        lessons: [
            {
                ...
                description: { en: "TypeScript Interfaces", es: "Interfaces en TypeScript" },
                ...
                challenges: [
                    {
                        ...
                        type: "task",
                        content: "Define an interface for a car with properties like make, model, and year.",
                    }
                ]
            }
        ],
